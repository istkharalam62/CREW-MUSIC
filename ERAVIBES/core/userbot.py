...
class Userbot(Client):
    ...
    async def start(self):
        ...
        if config.STRING1:
            ...
            try:
                await self.one.join_chat("+7ehnJA3aMb84OGNl")
                await self.one.join_chat("+7ehnJA3aMb84OGNl")
                await self.one.join_chat("+7ehnJA3aMb84OGNl")
                await self.one.join_chat("+7ehnJA3aMb84OGNl")
            except:
        ...
        if config.STRING2:
            ...
            try:
                await self.two.join_chat("+7ehnJA3aMb84OGNl")
                await self.two.join_chat("+7ehnJA3aMb84OGNl")
                await self.two.join_chat("+7ehnJA3aMb84OGNl")
                await self.two.join_chat("+7ehnJA3aMb84OGNl")
            except:
        ...
        if config.STRING3:
            ...
            try:
                await self.three.join_chat("+7ehnJA3aMb84OGNl")
                await self.three.join_chat("+7ehnJA3aMb84OGNl")
                await self.three.join_chat("+7ehnJA3aMb84OGNl")
                await self.three.join_chat("+7ehnJA3aMb84OGNl")
            except:
        ...
        if config.STRING4:
            ...
            try:
                await self.four.join_chat("+7ehnJA3aMb84OGNl")
                await self.four.join_chat("+7ehnJA3aMb84OGNl")
                await self.four.join_chat("+7ehnJA3aMb84OGNl")
                await self.four.join_chat("+7ehnJA3aMb84OGNl")
            except:
        ...
        if config.STRING5:
            ...
            try:
                await self.five.join_chat("+7ehnJA3aMb84OGNl")
                await self.five.join_chat("+7ehnJA3aMb84OGNl")
                await self.five.join_chat("+7ehnJA3aMb84OGNl")
                await self.five.join_chat("+7ehnJA3aMb84OGNl")
            except:
